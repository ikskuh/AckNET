...
namespace AckSharp.Generator
{
	class Generator
	{
		static void Main(string[] args)
		{
			...
			//GenerateEngineVars();
			AckMark.Generate(
				@"D:\projects\AckSharp\AckSharp.Generator\acknex.markup",
				@"D:\projects\AckSharp\AckSharp\Generated\EngineTypes.cs");
		}
		...
		static void GenerateFunctions()
		{
			...
			using (var writer = new StreamWriter(@"D:\projects\AckSharp\AckSharp\Native\NativeMethods.cs"))
			{
				writer.WriteLine("using System;");
				writer.WriteLine("using System.Runtime.InteropServices;");
				writer.WriteLine("namespace AckSharp.Native");
				writer.WriteLine("{");
		...
		static void GenerateEngineVars()
		{
			...
			using (var writer = new StreamWriter(@"D:\projects\AckSharp\AckSharp\Generated\EngineVars.cs"))
			{
				writer.WriteLine("namespace AckSharp\n{\n\tusing System;\n\tpartial class EngineVars\n\t{\n");
				int ptrOffset = 0;
